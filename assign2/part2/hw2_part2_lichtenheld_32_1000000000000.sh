...
#SBATCH --output=/ufrc/eel6763/slichtenheld/hw2_part2_32_1000000000000.out     # Standard output and error log
pwd; hostname; date
...
srun --mpi=pmi2 hw2_part2_lichtenheld -1.0 1.0 1000000000000
