...
#SBATCH --cpus-per-task=4            # Number of cores per MPI rank, usually 1 
...
#SBATCH --output=Part2%j.out     # Standard output and error log
pwd; hostname; date
...
srun --mpi=pmi2 part2 16384 16384 16384 4
